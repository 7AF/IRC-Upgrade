...
&nbsp;
        ...
        <asp:Button ID="LB_Odjava" runat="server" OnClick="LB_Odjava_Click" style="z-index: 1; left: 665px; top: 15px; position: absolute; height: 55px; width: 95px" Text="Odjava" ForeColor="Black" />
        <br />
        <asp:TextBox ID="TB_Sporocilo" runat="server" Height="75px" Width="417px"></asp:TextBox>
&nbsp;<asp:Button ID="B_Poslji" runat="server" CausesValidation="true" ValidationGroup="posiljanje" Height="78px" OnClick="B_Poslji_Click" Text="Pošlji" Width="108px" ForeColor="Black" />
&nbsp;<asp:Button ID="B_Osvezi" runat="server" Height="78px" OnClick="B_Osvezi_Click" Text="Refreš" Width="108px" /> 
        ...
        <asp:RequiredFieldValidator 
            ...
            ValidationGroup="posiljanje" ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
    </form>
</body>
</html>
